...
void save() {
	...
	for (int i = 0; i < objectcount; i++) {
		/*fprintf(File, "<object type='%c' id='%d' x='%d' y='%d w='%d' h='%d' color='%d' textColor='%d' fontSize='%d' point='", object[i].type, object[i].id, object[i].x, object[i].y, object[i].width, object[i].height,
			object[i].color->R*16*16*16 + object[i].color->G * 16 * 16 + object[i].color->B * 16 + object[i].color->A, object[i].textColor->R * 16 * 16 * 16 + object[i].textColor->G * 16 * 16 + object[i].textColor->B * 16 + object[i].textColor->A, 15);
		*/fprintf(File, "<object type='%c' id='%d' x='%d' y='%d' w='%d' h='%d'", object[i].type, object[i].id, object[i].x, object[i].y, object[i].width, object[i].height);
		if (object[i].type == 'T') {
